...
/**
 * MessageStatsRates Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class MessageStatsRates implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MessageStats_rates';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('complaint', $data ?? [], null);
    }
     ...
     * Sets bounced
     *
     * @param float|null $bounced bounced
     *
     * @return self
     */
     ...
     * Sets deferred
     *
     * @param float|null $deferred deferred
     *
     * @return self
     */
     ...
     * Sets complaint
     *
     * @param float|null $complaint complaint
     *
     * @return self
     */
    public function setComplaint($complaint)
    {
        if (is_null($complaint)) {
            throw new \InvalidArgumentException('non-nullable complaint cannot be null');
        }
