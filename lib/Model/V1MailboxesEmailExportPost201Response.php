...
/**
 * V1MailboxesEmailExportPost201Response Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1MailboxesEmailExportPost201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_mailboxes__email__export_post_201_response';
     ...
     * Sets url
     *
     * @param string $url Relative download URL. Caller appends to the API host.
     *
     * @return self
     */
