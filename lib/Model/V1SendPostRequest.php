...
/**
 * V1SendPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1SendPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_send_post_request';
    ...
    public function setTo($to)
    {
        ...
        if ((count($to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $to when calling V1SendPostRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets text
     *
     * @param string|null $text Plain-text body. Required if `html` is absent.
     *
     * @return self
     */
     ...
     * Sets html
     *
     * @param string|null $html HTML body. Required if `text` is absent.
     *
     * @return self
     */
     ...
     * Sets unsubscribe
     *
     * @param bool|null $unsubscribe Mark as opt-in/broadcast: skips suppressed recipients and adds a managed one-click List-Unsubscribe header.
     *
     * @return self
     */
     ...
     * Sets template_id
     *
     * @param string|null $template_id Render subject/text/html from a stored template (GET /v1/templates). Mutually exclusive with inline subject/text/html.
     *
     * @return self
     */
     ...
     * Sets variables
     *
     * @param array<string,string>|null $variables Values substituted into the template's {{variable}} placeholders.
     *
     * @return self
     */
     ...
     * Sets send_at
     *
     * @param \DateTime|null $send_at Schedule delivery for a future RFC3339 time (≤ 30 days out). Omit or past = send now. Cancel with DELETE /v1/messages/{id} while scheduled.
     *
     * @return self
     */
