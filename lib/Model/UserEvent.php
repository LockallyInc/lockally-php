...
class UserEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('days_inactive', $data ?? [], null);
    }
     ...
     * Sets event_at
     *
     * @param \DateTime|null $event_at event_at
     *
     * @return self
     */
    ...
    {
        if (is_null($event_at)) {
            throw new \InvalidArgumentException('non-nullable event_at cannot be null');
        }
    ...
    {
        return $this->container['days_inactive'];
    }

    /**
     * Sets days_inactive
     *
     * @param int|null $days_inactive days_inactive
     *
     * @return self
     */
    public function setDaysInactive($days_inactive)
    {
        if (is_null($days_inactive)) {
            throw new \InvalidArgumentException('non-nullable days_inactive cannot be null');
        }
        $this->container['days_inactive'] = $days_inactive;
