...
/**
 * VacationResponder Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class VacationResponder implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'VacationResponder';
    ...
    protected static $openAPITypes = [
        ...
        'enabled' => 'bool',
        'params' => '\Lockally\SDK\Model\VacationParams',
        'script' => 'string',
        'synced_at' => '\DateTime',
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime'
     ...
     * Gets params
     *
     * @return \Lockally\SDK\Model\VacationParams
     */
     ...
     * Sets params
     *
     * @param \Lockally\SDK\Model\VacationParams $params params
     *
     * @return self
     */
     ...
     * Sets script
     *
     * @param string $script Pre-rendered Sieve script (RFC 5230).
     *
     * @return self
     */
     ...
     * Sets synced_at
     *
     * @param \DateTime|null $synced_at Null = stored on lockally but not yet pushed to the mail server.
     *
     * @return self
     */
