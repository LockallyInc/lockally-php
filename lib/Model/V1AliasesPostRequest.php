...
/**
 * V1AliasesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1AliasesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_aliases_post_request';
    ...
    {
        $this->setIfExists('alias_address', $data ?? [], null);
        $this->setIfExists('alias_target', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['alias_address'] === null) {
            $invalidProperties[] = "'alias_address' can't be null";
        }
        if ($this->container['alias_target'] === null) {
            $invalidProperties[] = "'alias_target' can't be null";
        }
     ...
     * Sets alias_address
     *
     * @param string $alias_address alias_address
     *
     * @return self
     */
    public function setAliasAddress($alias_address)
    {
        if (is_null($alias_address)) {
            throw new \InvalidArgumentException('non-nullable alias_address cannot be null');
        }
    ...
    {
        return $this->container['alias_target'];
    }

    /**
     * Sets alias_target
     *
     * @param string $alias_target alias_target
     *
     * @return self
     */
    public function setAliasTarget($alias_target)
    {
        if (is_null($alias_target)) {
            throw new \InvalidArgumentException('non-nullable alias_target cannot be null');
        }
        $this->container['alias_target'] = $alias_target;
