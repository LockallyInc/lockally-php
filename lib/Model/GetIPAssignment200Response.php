...
/**
 * GetIPAssignment200Response Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class GetIPAssignment200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getIPAssignment_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pool_kind', $data ?? [], null);
     ...
     * @return string|null
     */
    public function getPoolKind()
    {
        return $this->container['pool_kind'];
    }

    /**
     * Sets pool_kind
     *
     * @param string|null $pool_kind pool_kind
     *
     * @return self
     */
    public function setPoolKind($pool_kind)
    {
        if (is_null($pool_kind)) {
            throw new \InvalidArgumentException('non-nullable pool_kind cannot be null');
        }
        $this->container['pool_kind'] = $pool_kind;
     ...
     * Sets dedicated_ip
     *
     * @param string|null $dedicated_ip dedicated_ip
     *
     * @return self
     */
     ...
     * Sets assigned_at
     *
     * @param \DateTime|null $assigned_at assigned_at
     *
     * @return self
     */
