...
/**
 * V1SendBatchPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1SendBatchPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_send_batch_post_request';
    ...
    protected static $openAPITypes = [
        'messages' => '\Lockally\SDK\Model\SendMessage[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['messages']) > 500)) {
            $invalidProperties[] = "invalid value for 'messages', number of items must be less than or equal to 500.";
        }
     ...
     * Gets messages
     *
     * @return \Lockally\SDK\Model\SendMessage[]
     */
     ...
     * Sets messages
     *
     * @param \Lockally\SDK\Model\SendMessage[] $messages messages
     *
     * @return self
     */
    public function setMessages($messages)
    {
        ...
        if ((count($messages) > 500)) {
            throw new \InvalidArgumentException('invalid value for $messages when calling V1SendBatchPostRequest., number of items must be less than or equal to 500.');
        }
        if ((count($messages) < 1)) {
            throw new \InvalidArgumentException('invalid length for $messages when calling V1SendBatchPostRequest., number of items must be greater than or equal to 1.');
        }
