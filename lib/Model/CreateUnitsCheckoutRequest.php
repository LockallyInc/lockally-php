...
/**
 * CreateUnitsCheckoutRequest Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class CreateUnitsCheckoutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createUnitsCheckout_request';
    ...
    public const BUNDLE__1K = '1k';
    public const BUNDLE__10K = '10k';
    public const BUNDLE__50K = '50k';
    public const BUNDLE__100K = '100k';
    public const BUNDLE__1PKT = '1pkt';
    public const BUNDLE__5PKT = '5pkt';
    public const BUNDLE__10PKT = '10pkt';
    public const BUNDLE__20PKT = '20pkt';
    ...
    public function setBundle($bundle)
    {
        ...
        $allowedValues = $this->getBundleAllowableValues();
        if (!in_array($bundle, $allowedValues, true)) {
