...
/**
 * V1SendPost202Response Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1SendPost202Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_send_post_202_response';
     ...
     * Sets id
     *
     * @param string $id Lockally identifier; use with GET /v1/messages/{id}.
     *
     * @return self
     */
     ...
     * Sets message_id
     *
     * @param string $message_id RFC 5322 Message-ID (with angle brackets).
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status \"scheduled\" when send_at is in the future.
     *
     * @return self
     */
