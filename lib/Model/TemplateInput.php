...
/**
 * TemplateInput Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class TemplateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TemplateInput';
     ...
     * Sets name
     *
     * @param string $name Template name (1–120 chars).
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string|null $subject May contain {{variable}} placeholders.
     *
     * @return self
     */
     ...
     * Sets html
     *
     * @param string|null $html HTML body; {{variable}} values are HTML-escaped.
     *
     * @return self
     */
