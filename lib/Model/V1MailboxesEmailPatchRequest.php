...
/**
 * V1MailboxesEmailPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1MailboxesEmailPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_mailboxes__email__patch_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['quota_bytes']) && ($this->container['quota_bytes'] < 0)) {
            $invalidProperties[] = "invalid value for 'quota_bytes', must be bigger than or equal to 0.";
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling V1MailboxesEmailPatchRequest., must be bigger than or equal to 8.');
        }
     ...
     * Sets quota_bytes
     *
     * @param int|null $quota_bytes quota_bytes
     *
     * @return self
     */
    public function setQuotaBytes($quota_bytes)
    {
        ...
        if (($quota_bytes < 0)) {
            throw new \InvalidArgumentException('invalid value for $quota_bytes when calling V1MailboxesEmailPatchRequest., must be bigger than or equal to 0.');
        }
