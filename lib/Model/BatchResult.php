 ...
 */
class BatchResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets error
     *
     * @param string|null $error Present when this message failed; the others are then absent.
     *
     * @return self
     */
