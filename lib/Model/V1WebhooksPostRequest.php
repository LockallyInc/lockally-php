...
/**
 * V1WebhooksPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1WebhooksPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_webhooks_post_request';
     ...
     * Sets url
     *
     * @param string $url HTTPS recommended (HTTP allowed for local development).
     *
     * @return self
     */
    ...
    public function setEvents($events)
    {
        ...
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling V1WebhooksPostRequest., number of items must be greater than or equal to 1.');
        }
