...
class CreateResourceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createResource_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'meeting_room');
    ...
    public function setCapacity($capacity)
    {
        ...
        if (($capacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $capacity when calling CreateResourceRequest., must be bigger than or equal to 0.');
        }
