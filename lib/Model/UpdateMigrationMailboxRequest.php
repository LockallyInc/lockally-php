...
/**
 * UpdateMigrationMailboxRequest Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateMigrationMailboxRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'updateMigrationMailbox_request';
     ...
     * Sets status
     *
     * @param string|null $status Can only be set to \"skipped\".
     *
     * @return self
     */
