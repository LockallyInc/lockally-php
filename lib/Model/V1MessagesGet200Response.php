...
/**
 * V1MessagesGet200Response Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1MessagesGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_messages_get_200_response';
    ...
    protected static $openAPITypes = [
        'data' => '\Lockally\SDK\Model\Message[]',
        'next_cursor' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Lockally\SDK\Model\Message[]
     */
     ...
     * Sets data
     *
     * @param \Lockally\SDK\Model\Message[] $data data
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor Pass as `cursor` to fetch the next page. Absent on the final page.
     *
     * @return self
     */
