...
/**
 * V1MailboxesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Lockally\SDK
 * @author   OpenAPI Generator team
 ...
 */
class V1MailboxesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_v1_mailboxes_post_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('quota_bytes', $data ?? [], 5368709120);
    }
     ...
     * Sets password
     *
     * @param string|null $password Optional; lockally generates if absent.
     *
     * @return self
     */
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling V1MailboxesPostRequest., must be bigger than or equal to 8.');
        }
     ...
     * Sets quota_bytes
     *
     * @param int|null $quota_bytes 5 GB default.
     *
     * @return self
     */
